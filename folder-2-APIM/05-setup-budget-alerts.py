...
def create_budget_alerts():
    ...
    thresholds = [
        ("cost-alert-25pct", 6.25, "25% of $25 budget reached"),
        ("cost-alert-50pct", 12.50, "50% of $25 budget reached"),
        ("cost-alert-75pct", 18.75, "75% of $25 budget reached — review usage!"),
        ("cost-alert-90pct", 22.50, "⚠️ 90% of $25 budget — take action!"),
    ]
    ...
    print("\n  Creating subscription-level budget ($100/mo)...")
    run(f'az consumption budget create '
        ...
        f'--start-date 2026-04-01 '
        f'--end-date 2027-04-01',
        "Creating $100/mo subscription budget...")

    print(f"\n  ✅ Subscription budget: $100/month")

    print("\n" + "=" * 70)
    print("  BUDGET SUMMARY")
    print("=" * 70)
    print(f"  Resource Group budget:   ${BUDGET_AMOUNT}/mo ({RESOURCE_GROUP})")
    print(f"  Subscription budget:     $100/mo (entire subscription)")
